...
export default function DevOpsAgilePage() {
  useEffect(() => {
    document.title = 'DevOps & Agile — Accelerate Delivery at Scale | Ancile Inc';
    window.scrollTo(0, 0);
  }, []);
    ...
    <section className="relative overflow-hidden" style={{ minHeight: '100vh' }}>
      ...
      >
        <div style={{ maxWidth: '580px' }}>
          ...
          >
            Partner with Ancile Inc to release faster, test smarter, and transform your engineering culture — spanning architecture, automation, and continuous delivery across your entire technology life cycle.
          </motion.p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} viewport={viewportOnce} transition={{ duration: 0.9, ease }}>
            ...
            <p className="text-base leading-relaxed text-slate-500 mb-6">
              The world's leading technology and software providers partner with Ancile Inc because of our scale, full-stack capabilities and speed. Together, we can deliver new, sustainable growth across your business.
            </p>
...
function InsightsSection() {
  const insights = [
    ...
    },
    {
      ...
      desc: 'How Ancile Inc and a global asset management firm embarked on a multiyear technology modernization initiative to migrate their full application portfolio to the cloud.',
    ...
    },
    {
      ...
      desc: 'How Ancile Inc partnered with an organization to transform their Microsoft Azure DevOps pipeline for improved user experiences and increased velocity.',
