        ...
        <div className="mx-auto max-w-[1280px] px-6 sm:px-8 lg:px-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-14">
            {[
              ...
              { step: '04', title: 'Innovation in Uncharted Territory', desc: 'Close collaboration between Ancile, the customer and dedicated Databricks resources ensured innovative problem-solving.' },
            ].map((d, i) => (
