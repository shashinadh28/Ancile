          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} viewport={viewportOnce} transition={{ duration: 0.85, ease }}>
              ...
              <p className="text-base leading-relaxed text-slate-500">
                Google Cloud was J.B. Hunt's platform-of-choice for this undertaking, largely due to the benefits of their infrastructure and the reporting capabilities offered through BigQuery. As a Google Cloud Premier Partner, Ancile was more than up to the task.
              </p>
            </motion.div>
