...
const US_LOCATIONS = [
  ...
  {
    name: 'South Carolina – Branch Office',
    ...
    >
      ...
      <div className="mx-auto max-w-page container-px py-16 sm:py-20">
        ...
        >
          ...
          <motion.div variants={fadeUp}>
            ...
            <p className="mt-6 text-xs text-white/40">
              © 2024 Ancile Inc. All Rights Reserved
            </p>
            <a href="#" className="mt-1 block text-xs text-white/40 hover:text-white transition-colors">
              Privacy Policy
            </a>
          </motion.div>
          ...
          <motion.div variants={fadeUp} className="sm:col-span-2 lg:col-span-2">
            ...
            >
              {SERVICES.map((s) => (
                <motion.li key={s} variants={fadeUpSmall}>
                  <a
                    href="#services"
                    className="group inline-flex items-center text-sm text-white/70 transition-colors hover:text-white"
                  >
        ...
        >
          ...
          >
            <span className="inline-flex h-5 w-7 items-center justify-center rounded-sm border border-white/15 bg-white/5 text-[10px] font-bold text-white/80">
              US
            </span>
            US Locations
          </motion.h4>
          ...
          {/* India Location */}
          <motion.div variants={fadeUp}>
            <h4 className="text-xs font-semibold uppercase tracking-[0.18em] text-white/45 flex items-center gap-2 mb-4">
              <span className="inline-flex h-5 w-7 items-center justify-center rounded-sm border border-white/15 bg-white/5 text-[10px] font-bold text-white/80">
                IN
              </span>
              India Location
            </h4>
            <p className="text-sm font-semibold text-white/90">Vijayawada, India</p>
            <ul className="mt-2 space-y-1 text-sm text-white/65">
              <li>D No: 5-141, Koudinya Nagar,</li>
              <li>Penamaluru (MD), (PO), Krishna District,</li>
              <li>Andhra Pradesh 521139</li>
              <li className="mt-2">📧 info@ancileinc.com</li>
