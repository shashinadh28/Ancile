...
const SOCIALS = [
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/ancileinc',
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/ancileinc',
  ...
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/company/ancile-inc',
        ...
        >
          ...
          <motion.div variants={fadeUp}>
            ...
            <div className="mt-6 text-sm text-white/65 space-y-1">
              ...
              <p>📞 913.804.7687</p>
              <p className="mt-2">
                <a href="mailto:info@ancileinc.com" className="hover:text-white transition-colors">
                  📧 info@ancileinc.com
                </a>
              </p>
            </div>
            ...
            <p className="mt-6 text-xs text-white/40">
              © 2025 Ancile Inc. All Rights Reserved.
            </p>
