...
const SPECIALTIES = [
  {
    ...
    sub: 'Full-Stack · Backend · Frontend',
    img: '/specialities/Software_Engineering.webp',
    icon: CodeIcon,
  },
  {
    name: 'Data Engineering',
    sub: 'Pipelines · Platforms · Lakehouse',
    img: '/specialities/Data-Engineering.webp',
    icon: DatabaseIcon,
  },
  {
    name: 'Cloud / DevOps',
    sub: 'AWS · Azure · GCP · CI/CD · SRE',
    img: '/specialities/Cloud-DevOps.webp',
    icon: CloudIcon,
  },
  {
    name: 'QA / Automation',
    sub: 'Quality Engineering · Test Automation',
    img: '/specialities/QA-Automation.webp',
    icon: CheckIcon,
  },
  {
    name: 'Cybersecurity',
    sub: 'Security Engineering & Operations',
    img: '/specialities/Cybersecurity.webp',
    icon: ShieldIcon,
  },
  {
    name: 'Product / PMO / BA',
    sub: 'Product · Business Analysis · PMO',
...
export default function TalentSpecialties() {
  return (
    <section
      ...
      style={{ backgroundColor: '#0B1120', ...GRID_BG }}
    >
      {/* Pulsing rings */}
      ...
      <div className="mx-auto max-w-[1280px] px-6 sm:px-8 lg:px-12 relative z-10">
        ...
        >
          ...
          >
            Talent for{' '}
            <span style={{ color: ACCENT }}>critical functions</span>
          </motion.h2>
          ...
          {SPECIALTIES.map((s, i) => {
            ...
            return (
              ...
              >
                ...
                />
                {/* Border color on hover via box-shadow */}
                <span
