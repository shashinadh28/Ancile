# Ancile Inc — Premium Animated Landing Page

A modern, animation-rich, Awwwards-style landing page for **Ancile Inc**, built from scratch with **React**, **Tailwind CSS**, and **Framer Motion**.
